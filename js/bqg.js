...
if(/Android|Windows Phone|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)){
    ...
    if (url.match(/\/\/www\.xbiquge\.la\//)) { Go('https://m.xbiquge.la/'); }

    id = url.match(/\/\d+\/(\d+)\//);
    if (id){Go('https://m.xbiquge.la/wapbook/'+id[1]+'.html');}

    id = url.match(/\/\d+\/(\d+)\/(\d+).html/);
    if (id){Go('https://m.xbiquge.la/wapbook/'+id[1]+'_' + id[2] + '.html');}
...
//document.writeln('<div style="position:fixed;bottom:10px;left:10px"><a href="http://pic.ting56.com/apk/firstvideo.4.5.1.100102.apk"><img style="width:140%;" src="https://www.xbiquge.la/images/fv.jpg" alt="apk download"></a></div>');
function login(){
...
document.writeln("		<div class=\"ywtop_addfavorite\"><a href=\"#\" onclick=\"javascript:window.external.addFavorite(\'https://www.xbiquge.la\',\'新笔趣阁_书友最值得收藏的网络小说阅读网\')\">收藏新笔趣阁</a></div>");
...
document.writeln('<p>Copyright &copy; 2015-2022 <a href="https://www.xbiquge.la/">新笔趣阁</a> All Rights Reserved.</p>');
